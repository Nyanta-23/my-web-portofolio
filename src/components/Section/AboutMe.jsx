...
function AboutMe() {
  return (
    <article className="border-2 border-none rounded-md bg-custom-black z-10 py-10 px-2 text-custom-white sm:w-11/12 md:w-7/12">
      <h2 className="text-3xl text-center font-bold">Hi👋, I'm Ilhan</h2>
